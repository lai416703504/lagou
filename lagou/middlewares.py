...
class LagouScrapyUserAgentMiddleware(UserAgentMiddleware):
    ...
    def __init__(self, user_agent):
        ...
        super(LagouScrapyUserAgentMiddleware, self).__init__(user_agent)
    ...
    def process_request(self, request, spider):
        ...
        request.headers['Referer'] = "'https://www.lagou.com/jobs/list_" + urllib.quote(settings['REFERER_NAME'])
